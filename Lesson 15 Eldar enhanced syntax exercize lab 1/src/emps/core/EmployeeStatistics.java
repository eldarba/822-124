...
public class EmployeeStatistics {
	 ...
	 */
	public static double averageSalary(Collection<Employee> emps) {
		double salarySum = 0D;
		int numOfEmps = 0;
	 ...
	 */
	public static int numOfEmployees(Collection<Employee> emps) {
		int numOfEmps = 0;
		Iterator<Employee> it = emps.iterator();
		while (it.hasNext()) {
			Employee currEmp = it.next();
	 ...
	 * @return
	 */
	public static int numOfEmployees(Collection<Employee> emps, String departmentName) {
		int numOfEmps = 0;
		Iterator<Employee> it = emps.iterator();
		while (it.hasNext()) {
			Employee currEmp = it.next();
